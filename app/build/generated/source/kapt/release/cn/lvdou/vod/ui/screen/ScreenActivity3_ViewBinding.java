...
public class ScreenActivity3_ViewBinding implements Unbinder {
  private ScreenActivity3 target;
  ...
  @UiThread
  public ScreenActivity3_ViewBinding(ScreenActivity3 target) {
    this(target, target.getWindow().getDecorView());
  }

  @UiThread
  public ScreenActivity3_ViewBinding(final ScreenActivity3 target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    ScreenActivity3 target = this.target;
