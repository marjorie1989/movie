...
public class ScreenActivity_ViewBinding implements Unbinder {
  ...
  @UiThread
  public ScreenActivity_ViewBinding(ScreenActivity target) {
    this(target, target.getWindow().getDecorView());
  }

  @UiThread
  public ScreenActivity_ViewBinding(final ScreenActivity target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    ScreenActivity target = this.target;
