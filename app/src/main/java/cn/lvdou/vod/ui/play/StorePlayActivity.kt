...
import kotlinx.android.synthetic.main.activity_store_play.*
import java.io.File
...
class StorePlayActivity : BaseActivity() {
    ...
    // lateinit var videoView :AvVideoView
    ...
    override fun initView() {
        ...
        //添加手势
        var gestureControlView = GestureView(this)
        ...
        var ins: List<File> = file.listFiles().filter { it.name.equals("play.ts") }



        Log.d(TAG, "ins[0]${ins[0].absolutePath}")
        videoView.setUrl(ins[0].absolutePath)
        // videoView.setUrl("https://video.699pic.com/videos/30/57/12/b_GDDm9f7CbgI11607305712.mp4")
        videoView.start()
...
//        }
    ...
    override fun initListener() {
        ...
        controller.setControllerClickListener ( object : ControllerClickListener {
