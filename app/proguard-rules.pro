...
-keepclassmembers class cn.lvdou.vod.ad.AdWebView$JsInteraction {
  public *;
}
-keepattributes *Annotation*
-keepattributes *JavascriptInterface*
-keep public class cn.lvdou.vod.ad.AdJavascriptInterface{
    public <methods>;
}
...
-keepattributes *Annotation*
-dontwarn sun.misc.**
-keep class cn.lvdou.vod.bean.** { <fields>; }
-keep class cn.lvdou.vod.entity.** { <fields>; }
...
-keep public class cn.lvdou.vod.R$*{
...
-keep class cn.lvdou.av.**{*;}
-keep class cn.lvdou.vod.ui.widget.**{*;}
